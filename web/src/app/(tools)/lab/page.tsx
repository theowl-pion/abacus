...
export default function LabPage() {
  ...
  return (
    <div className="mx-auto flex h-full max-w-2xl flex-col gap-6 overflow-y-auto overflow-x-auto rounded-2xl border border-black/10 p-8 dark:border-white/10">
